...
(function() {
  var DbxClient, DbxEnvGlobal, DbxXhrArrayBufferView, DbxXhrCanSendForms, DbxXhrDoesPreflight, DbxXhrIeMode, DbxXhrRequest, DbxXhrSendArrayBufferView, DbxXhrWrapBlob, Dropbox, error1,
  ...
  Dropbox.Util.EventSource = (function() {
    ...
    EventSource.prototype.removeListener = function(listener) {
      var i, index, k, len, ref, subscriber;
    ...
    EventSource.prototype.dispatch = function(event) {
      var k, len, listener, ref, returnValue;
      ref = this._listeners;
  ...
  Dropbox.ApiError = (function() {
    ...
    function ApiError(xhr, method1, url1) {
      var error1, error2, error3, error4, text, xhrError;
      this.method = method1;
      this.url = url1;
  ...
  Dropbox.AuthDriver.BrowserBase = (function() {
    ...
    BrowserBase.prototype.storeCredentials = function(credentials, callback) {
      var error1, jsonString, name, storageError, value;
    ...
    BrowserBase.prototype.loadCredentials = function(callback) {
      var cookieRegexp, error1, error2, jsonError, jsonString, match, name, nameRegexp, storageError;
      try {
    ...
    BrowserBase.prototype.forgetCredentials = function(callback) {
      var error1, expires, name, storageError;
      try {
    ...
    BrowserBase.localStorage = function() {
      var deprecationError, error1;
      if (typeof window !== 'undefined') {
        try {
          return window.localStorage;
        } catch (error1) {
          deprecationError = error1;
          return null;
        }
      } else {
        return null;
  ...
  Dropbox.AuthDriver.Popup = (function(superClass) {
    ...
    Popup.prototype.doAuthorize = function(authUrl, stateParam, client, callback) {
      ...
      win = this.openWindow(authUrl);
      return this.checkClosed(win, callback);
    };
    ...
    Popup.prototype.checkClosed = function(win, callback) {
      if (win.closed) {
        return callback({
          error: 'closed',
          error_description: 'Window closed by user'
        });
      } else {
        return this.checkClosedTimeout = setTimeout(((function(_this) {
          return function() {
            return _this.checkClosed(win, callback);
          };
        })(this)), 300);
      }
    };
    ...
    Popup.prototype.listenForMessage = function(stateParam, callback) {
      ...
      listener = (function(_this) {
        return function(event) {
          var data, error1, jsonError, oauthInfo;
          if (event.data) {
            data = event.data;
          } else {
            data = event;
          ...
          if (_this.locationStateParam(oauthInfo) === stateParam) {
            ...
            if (_this.checkClosedTimeout) {
              return clearTimeout(_this.checkClosedTimeout);
            }
          }
        };
      })(this);
    ...
    Popup.oauthReceiver = function() {
      window.addEventListener('load', function() {
        var error1, error2, frameError, ieError, message, opener, pageOrigin, pageUrl;
  ...
  Dropbox.AuthDriver.Electron = (function(superClass) {
    extend(Electron, superClass);

    function Electron(options) {
      Electron.__super__.constructor.call(this, options);
    }

    Electron.prototype.url = function() {
      return 'https://www.dropbox.com/1/oauth2/redirect_receiver';
    };

    Electron.prototype.doAuthorize = function(authUrl, stateParam, client, callback) {
      var closed, win;
      closed = false;
      ...
      win.loadUrl(authUrl);
      win.show();
      win.webContents.on('did-finish-load', (function(_this) {
        return function() {
          var url;
          ...
          if (_this.locationStateParam(url) === stateParam) {
            ...
            closed = true;
            win.close();
            return callback(Dropbox.Util.Oauth.queryParamsFromUrl(url));
          }
        };
      })(this));
      return win.on('closed', (function(_this) {
        return function() {
          win = null;
          if (closed) {
            return;
          }
          return callback(new Dropbox.AuthError('error=access_denied&error_description=User+closed+browser+window'));
        };
      })(this));
    };
      ...
      return this.stat(path, statOptions, function(error, stat, entry_stats) {
        ...
        if (entry_stats) {
          entries = (function() {
            var k, len, results1;
            results1 = [];
            for (k = 0, len = entry_stats.length; k < len; k++) {
              entry_stat = entry_stats[k];
      ...
      return this._dispatchXhr(xhr, function(error, versions) {
        ...
        if (versions) {
          stats = (function() {
            var k, len, results1;
            results1 = [];
            for (k = 0, len = versions.length; k < len; k++) {
              metadata = versions[k];
  ...
  (function() {
    var _base64Digits, arrayToBase64, crypto, error1, hmacSha1, requireError, sha1, sha256, sha256Init, sha256Key, stringToArray, xxx;
    ...
    sha1 = function(string, length) {
      var a, a0, b, b0, c, c0, d, d0, e, e0, i, j, k, limit, n, state, t;
    ...
    sha256Key = [];
    (function() {
      var factor, fractional, i, isPrime, k, prime, results1;
  ...
  Dropbox.Util.Oauth = (function() {
    ...
    Oauth.queryParamsFromUrl = function(url) {
      var fragment, fragmentOffset, k, kvp, len, match, offset, params, query, ref;
      match = /^[^?#]+(\?([^\#]*))?(\#(.*))?$/.exec(url);
      if (!match) {
        return {};
      }
  ...
  Dropbox.Util.Xhr = (function() {
    ...
    Xhr.prototype.setFileField = function(fieldName, fileName, fileData, contentType) {
      var blob, blobError, boundary, builder, error2, useFormData;
      if (this.body !== null) {
        throw new Error('Request already has a body');
      }
      if (this.isGet) {
    ...
    Xhr.urlDecode = function(string) {
      var k, kvp, len, ref, result, token;
      result = {};
      ref = string.split('&');
      for (k = 0, len = ref.length; k < len; k++) {
        token = ref[k];
    ...
    Xhr.prototype.onReadyStateChange = function() {
      var allHeaders, apiError, bytes, contentType, dirtyText, duplicateIndex, error2, error3, headers, i, jsonError, k, metadata, metadataJson, offset, ref, text;
      ...
      if (this.responseType) {
        if (this.responseType === 'b') {
          ...
          bytes = [];
          for (i = k = 0, ref = dirtyText.length; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
    ...
    Xhr.parseResponseHeaders = function(allHeaders) {
      var colonIndex, headerLines, headers, k, len, line, name, value;
      headers = {};
      headerLines = allHeaders.split("\n");
      for (k = 0, len = headerLines.length; k < len; k++) {
        line = headerLines[k];
    ...
    Xhr.prototype.guessResponseHeaders = function() {
      var headers, k, len, name, ref, value;
      headers = {};
